...
@NgModule({
  ...
  declarations: [RestaurantListComponent, RestaurantDetailComponent, ReviewsListComponent, SortByComponent,HeaderComponent,FoodListComponent,OrderComponent,ViewOrderComponent,OrderDetailsComponent,CartComponent],
